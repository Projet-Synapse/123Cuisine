          ...
          <ScreenContainer style={{ maxWidth: 640 }}>
            ...
            <View
              style={[
                styles.previewCard,
                {
                  backgroundColor: selectedSupermarket.color + '15',
                  borderColor: selectedSupermarket.color + '40',
                  borderWidth: 1.5,
                },
              ]}
            >
              <View
                style={[styles.smColorDot, { backgroundColor: selectedSupermarket.color, width: 16, height: 16 }]}
              />
              <View>
                <Text style={[styles.previewName, { color: Colors.text }]}>{name || 'Nom de la liste'}</Text>
                <Text style={[styles.previewSub, { color: selectedSupermarket.color }]}>
                  {selectedSupermarket.name} · {list.items.length} article{list.items.length > 1 ? 's' : ''}
                </Text>
              </View>
            </View>
          </ScreenContainer>
